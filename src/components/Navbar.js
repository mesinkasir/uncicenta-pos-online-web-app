      ...
      <div className="container-fluid">
        <Link className="navbar-brand" to="/">
          <img
            width="120"
            className="img-fluid"
            src="https://1.bp.blogspot.com/-kEdzN7AdSTQ/YDZLAt-auvI/AAAAAAAANE8/tLb0TUK785YwtOSNmIcWG0LS0IDOllqaQCLcBGAsYHQ/s168/uni.png"
          />
        </Link>
        <button
          className="navbar-toggler btn bg-info"
          type="button"
        ...
        >
          <svg
            ...
            height="26"
            fill="currentColor"
            className="text-white bi bi-columns-gap"
            viewBox="0 0 16 16"
          >
        ...
        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div className="navbar-nav">
            ...
            <NavLink className="nav-link text-white" to="/group">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <NavLink className="nav-link text-white" to="/cost">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <NavLink className="nav-link text-white" to="/update">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <a
              ...
              href="https://sourceforge.net/projects/unicentaandroid/files/unicenta-ng.apk/download"
            >
              Download APK
            </a>
            <a className="btn btn-info border border-dark" href="/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
